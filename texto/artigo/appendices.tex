...
\falta{candidatos a material suplementar/apêndice: (i) métricas complementares de validação da PCE nos 10 instantes da Tabela~\ref{tab:validation_results}; (ii) equações dos três trechos da regressão por partes do CO$_2$; (iii) hiperparâmetros finais da RNA}
