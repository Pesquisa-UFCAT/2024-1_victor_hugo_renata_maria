...
\section{Introdução}\label{sec:intro}\input{Section_1}
\section{Corrosão induzida por carbonatação}\label{sec:carb}\input{Section_2}
\section{Resistência residual à flexão e função de estado limite}\label{sec:resist}\input{Section_3}
\section{Emulador estocástico dependente do tempo baseado na Distribuição Lambda Generalizada}\label{sec:emulador}\input{Section_4}
\section{Da distribuição emulada à vida útil remanescente}\label{sec:rul}\input{Section_5}
\section{Resultados e discussão}\label{sec:res}\input{Section_6}
\section{Conclusões}\label{sec:conc}\input{Section_7}
